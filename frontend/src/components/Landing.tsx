...
export default function Landing() {
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden transition-colors">
      <AnimatedBackground />
      <div className="fixed top-0 right-0 z-10 px-6 py-3">
        <DarkModeToggle />
      </div>
      ...
      <header className="min-h-screen flex flex-col justify-center items-center text-center flex-1 px-6 animate-fadeIn-delay opacity-0">
        <div className="max-w-5xl">
            <h1 className="text-6xl md:text-7xl font-bold mb-6 text-gray-900 dark:text-gray-100 transition-colors drop-shadow-md">
            Interview Response Analyser
            </h1>
          <p className="text-gray-600 dark:text-gray-300 text-xl md:text-2xl mb-12 transition-colors">
            Personalised AI-powered feedback on your behavioral interview responses
          </p>
          <a
            href="/interview-analyser"
            className="bg-indigo-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-indigo-600 transition cursor-pointer"
          >
            Get Started
          </a>
        </div>
      ...
      <main className="px-6 pb-42">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {/* Feature 1 */}
          <div className="bg-card/40 p-8 rounded-2xl shadow-lg hover:shadow-xl transition flex flex-col items-center text-center">
